...
The car model is not included in the file but can be downloaded from [blender kit](https://www.blenderkit.com/asset-gallery?query=category_subtree:model+mclearn+order:_score). You may have to decrease the poly count as it is a bit high.
